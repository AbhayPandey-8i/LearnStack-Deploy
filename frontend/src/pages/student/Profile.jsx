                ...
                <div>
                    ...
                    <Dialog>
                        <DialogTrigger asChild>
                            <Button size='sm' className="mt-2 bg-gray-900 text-white">Edit Profile</Button>
                        </DialogTrigger>
                        <DialogContent className={"bg-white text-black"} >
                            ...
                            <div className='grid gap-4 py-4'>
                                ...
                                <div className='grid grid-cols-4 items-center gap-4 '>
                                    ...
                                    <Input type="file" onChange={onChangeHandler} accept="image/*" placeholder="Name" className="col-span-3" />
                                </div>
                            </div>
                            <DialogFooter>
