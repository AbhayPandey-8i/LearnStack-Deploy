...
const CourseProgress = () => {
  ...
  const { courseDetails, progress, compeleted } = data.data;
  const { courseTitle } = courseDetails;

  //initialize first lecture is not exist
  ...
  return (
    <div className='max-w-7xl mx-auto p-4 mt-20' >
      ...
      <div className='flex justify-between mb-4' >
        ...
        <Button className={"bg-black text-white"} >Completed</Button>
          ...
          <div className='flex-1 overflow-y-auto'>
            {
              courseDetails?.lectures.map((lecture) => (
                ...
                <div
                  key={lecture._id}
                  className={`mb-3 border border-gray-300 rounded-lg hover:cursor-pointer transition transform ${lecture._id === currentLecture?._id
